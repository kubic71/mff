...
def plot_experiments(prefix="logs", exp_ids = ["experiment"], rename_dict=None, stat_type='objective'):
    if not rename_dict:
        rename_dict = dict()
    for e in exp_ids:
...
class Log:    
    ...
    #                     appended)
    def __init__(self, prefix = "logs", exp_id = "experiment", run_id = 1, write_immediately = False, 
